    ...
    <div
      className={`relative overflow-hidden backdrop-blur-sm transition-all duration-300 rounded-xl ${
        isTodayDate
          ...
          : 'bg-gradient-to-br from-slate-700/90 to-slate-800/90 border border-slate-600/60 hover:border-slate-500 hover:shadow-lg'
      }`}
    >
      {isTodayDate && (
      ...
      <button
        ...
        className="w-full text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-ramadan-green rounded-lg"
      ...
      >
        <div className="p-4 sm:p-5 relative z-10">
          ...
          <div className="grid grid-cols-2 gap-2 mt-3">
            <div className="flex items-center gap-2 rounded-lg bg-slate-700/50 px-3 py-2 border border-blue-500/40">
            ...
            <div className="flex items-center gap-2 rounded-lg bg-slate-700/50 px-3 py-2 border border-ramadan-gold/50">
        ...
        {expanded && (
          ...
          >
            <div className="px-4 sm:px-5 pb-4 sm:pb-5 relative z-10 pt-0 space-y-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                  {PRAYER_KEYS.map(({ key, labelKey, icon: Icon, color }) => {
                    ...
                    return (
                      <div
                        key={key}
                        className={`rounded-lg p-2.5 border ${styles.border} ${styles.bg} transition-colors`}
                      >
              ...
              {/* Dua of the day */}
              <div className="rounded-xl bg-gradient-to-br from-ramadan-gold/10 to-qatar-maroon/10 border border-ramadan-gold/30 p-4">
                ...
                <div className="bg-slate-800/60 rounded-lg p-3 mb-2 border border-slate-600/50">
                  <p className="text-lg sm:text-xl text-right leading-relaxed text-ramadan-green font-arabic">
                    {dua.arabic}
                  </p>
                </div>
