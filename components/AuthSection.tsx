    ...
    <div className="space-y-4">
      ...
      <form onSubmit={handleEmailSubmit} className="space-y-2">
        <input
          ...
          className="w-full rounded-lg border border-slate-600 bg-slate-800 px-3 py-2 text-sm text-slate-100 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-green"
          autoComplete="email"
        />
        <input
          type="password"
