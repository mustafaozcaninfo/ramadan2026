  ...
  return (
    <section className="mx-auto max-w-md rounded-2xl border border-slate-600/60 bg-slate-900/65 p-5 sm:p-6 shadow-2xl">
      <div className="mb-5 text-center">
        <div className="mx-auto mb-3 inline-flex h-12 w-12 items-center justify-center rounded-full border border-brand-gold/50 bg-slate-950/70 text-brand-gold">
      ...
      <form onSubmit={onSubmit} className="space-y-3">
        ...
        <input
          ...
          className="h-11 w-full rounded-lg border border-slate-600/70 bg-slate-950/70 px-3 text-sm text-slate-100 placeholder:text-slate-500 focus:border-brand-gold/60 focus:outline-none"
        ...
        <button
          ...
          className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-brand-green px-4 text-sm font-semibold text-white transition hover:bg-emerald-500 disabled:cursor-not-allowed disabled:opacity-50"
        >
